...
class Visualizer:
    ...
    @classmethod
    def initialize(cls, visualize,args,vis_path):
    ...
    @classmethod
    def visualize_prediction_batch(cls, spt_img_b, spt_mask_b, qry_img_b, qry_mask_b, pred_mask_b, cls_id_b, batch_idx, nested,iou_b=None):
        ...
        for sample_idx, (spt_img, spt_mask, qry_img, qry_mask, pred_mask, cls_id) in \
            ...
            cls.visualize_prediction(spt_img, spt_mask, qry_img, qry_mask, pred_mask, cls_id, batch_idx, sample_idx, True, nested, iou)
    ...
    @classmethod
    def visualize_prediction(cls, spt_imgs, spt_masks, qry_img, qry_mask, pred_mask, cls_id, batch_idx, sample_idx, label, nested, iou=None):
        ...
        os.makedirs(cls.vis_path + f'/{nested}', exist_ok=True)
        merged_pil.save(cls.vis_path + f'/{nested}/%d_class-%d_iou-%.2f' % (batch_idx, cls_id, iou) + '.jpg')
