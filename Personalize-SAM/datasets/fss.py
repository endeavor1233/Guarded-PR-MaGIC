...
class DatasetFSS(Dataset):
    def __init__(self, datapath, fold, transform, split, shot, use_original_imgsize):
        ...
        # Official FSS-1000 split files are supplied by the Matcher release.
        # Keep the original repository contract here: the data root must
        # contain FSS-1000/data and FSS-1000/splits/{trn,val,test}.txt.
